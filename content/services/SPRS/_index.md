...
title: SPRS
layout: hextra-home
description: SPRS is focused on cybersecurity compliance — specifically your score against NIST SP 800-171 controls.
---
...
You'll also need a System Security Plan (SSP) documenting your policies before you assess — the SSP is foundational for any self-assessment and for consideration for any DoD contract.
...
Starting with the CMMC phased rollout that began November 10, 2025, DoD contracting officers will not award, extend, or renew a contract unless the contractor has both a passing result of a current self-assessment and an executive affirmation of continuous compliance submitted in SPRS. Industry FSO
Two critical accuracy warnings
Submitting an inaccurate or inflated score exposes organizations to significant legal and financial risk under the False Claims Act. DIBCAC is authorized under DFARS 252.204-7020 to audit and validate submitted scores.
...
<br>
{{< /hextra/feature-grid >}}
The self-assessment must have been completed within the last three years and be maintained for the duration of the contract. Scores older than three years make a contractor ineligible to compete.
