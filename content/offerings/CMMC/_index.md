...
{{< tabs items="Level 1 — Foundational,Level 2 — Advanced,Level 3 — Expert" >}}
...
- **Practices:** 110 (full NIST SP 800-171 alignment)
- **Assessment:** Triennial C3PAO assessment for critical contracts; self-assessment for non-critical
...
- **Practices:** 110+ (NIST SP 800-171 + additional practices from NIST SP 800-172)
- **Assessment:** Government-led assessment conducted by DCSA
- **Scope:** Highest-priority DoD programs involving advanced persistent threats
- **Who it applies to:** Contractors on select DoD programs with elevated risk designation

{{< callout type="info" >}}
GreylineOps is built specifically for Level 3. Our entire practice — gap assessments, SSP documentation, remediation, and mock assessments — is tuned to DCSA's assessment standard.
{{< /callout >}}
{{< /tab >}}
